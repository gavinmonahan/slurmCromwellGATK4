...
import "ruddle_fastq_to_bam_single_sample_gatk4.wdl" as single_wf


workflow Multisample_Fastq_to_Bam_GATK4 {
  ...
  scatter (sample in make_uniq_samples_file.uniq_samples) {
   ...
   call single_wf.Fastq_to_Bam_GATK4 { 
      input: 
  ...
  output {
    Array[Array[File]] unmapped_bam = Fastq_to_Bam_GATK4.unmapped_bam
    Array[File] duplication_metrics = Fastq_to_Bam_GATK4.duplication_metrics
    Array[File] bqsr_report = Fastq_to_Bam_GATK4.bqsr_report
    Array[File] analysis_ready_bam = Fastq_to_Bam_GATK4.analysis_ready_bam
    Array[File] analysis_ready_bam_index = Fastq_to_Bam_GATK4.analysis_ready_bam_index
    Array[File] analysis_ready_bam_md5 = Fastq_to_Bam_GATK4.analysis_ready_bam_md5
